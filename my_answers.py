...
class NeuralNetwork(object):
    ...
    def train(self, features, targets):
        ...
        # print("h_o", self.weights_hidden_to_output)
    ...
    def forward_pass_train(self, X):
        ...
        # print("real: ", X.shape, hidden_inputs.shape, self.weights_input_to_hidden.shape)
    ...
    def backpropagation(self, final_outputs, hidden_outputs, X, y, delta_weights_i_h, delta_weights_h_o):
        ...
        # error = error * final_outputs * (1 - final_outputs)
        # print("shape: ", error.shape, self.weights_hidden_to_output.shape)
        # TODO: Calculate the hidden layer's contribution to the error
        hidden_error = np.matmul(error, self.weights_hidden_to_output.T)
        # hidden_error = error * self.weights_hidden_to_output
        # print("hid shape: ", hidden_error.shape)
        ...
        # print("del_h_o: ", delta_weights_h_o.shape, output_error_term.shape, hidden_outputs.shape)
